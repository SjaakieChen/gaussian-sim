...
- `../testmaster_alignment/README.md`
...
```text
#SM_PROCESS#\Python\testmaster_alignment\  (process-specific test/development)
...
WorkingDirectory = "#SM_PROCESS#\Python\"
PythonInterpreter = "#SM_SYSTEM#\Python\.venv\Scripts\python.exe"
LogDirectory = "#SM_PROCESS#\Python\log"
...
- `Python_310_ALIGNMENT_TEST` is the `Interpreter` name used by
  `TMPython_ExecuteScript`.

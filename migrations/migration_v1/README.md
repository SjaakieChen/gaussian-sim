...
- `yase_example_processes\YASE_MACHINE_CONVENTIONS.md` for machine-axis to simulation-axis mapping.
- `yase_example_processes\YASE_PYTHON_INTEGRATION_README.md` for the TMPython JSON move contract.
- `yase_example_processes\YASE_PROGRAMMING_GUIDE.md` for safe subsequence structure and motion checks.
- `yase_example_processes\SUB_Positioning\SUB_Test_DrawCircle_AlignX1Z1.xseq` for the guarded `MoveStage` / wait / axis-check pattern.
